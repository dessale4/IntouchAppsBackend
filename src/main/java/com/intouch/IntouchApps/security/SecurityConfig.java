...
//                                        "/swagger-ui.html"
                                        ...
                                        .requestMatchers(HttpMethod.POST, "/user-roles/**")
                                        .hasAnyAuthority( "ROLE_LIVEROOM_MANAGER", "ROLE_ADMIN", "ROLE_MANAGER")
                                        ...
                                        .hasAnyAuthority("ROLE_LIVEROOM_OWNER", "ROLE_LIVEROOM_MANAGER","ROLE_ADMIN", "ROLE_MANAGER")
                                        .anyRequest()
                                        .authenticated()
                )
